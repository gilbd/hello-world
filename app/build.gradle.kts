...
android {
    namespace = "com.babymonitor"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.babymonitor"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // ML Kit for sound classification (cry detection)
    implementation("com.google.mlkit:sound-classification:16.1.0")
